...
class Consts {
  ...
  static var firstSubTitle =
      "Make it easier for you to maintain your plant(s) with our guides.";
  static var secondTitle = "Did your plant go sick?";
  static var secondSubTitle =
      "Take a picture and we will help you take care of it.";
  ...
  // methods
  static Future<dynamic> alertPopup(BuildContext context, String reason,
      {String title = 'Error', String button = 'Ok'}) {
    return showDialog(
        context: context,
